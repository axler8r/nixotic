...
import "../GetDockerDanglingVolumes"
import "../../lib/testing"

suite "Get-DockerDanglingVolumes parseDockerList":
...
suite "Get-DockerDanglingVolumes run":
  test "prints usage and returns 0 for --help":
    ...
    removeFile(tmp)
    check code == 0
    check content.contains("Usage: Get-DockerDanglingVolumes")
